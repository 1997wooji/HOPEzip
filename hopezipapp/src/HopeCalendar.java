...
public class HopeCalendar extends JFrame implements ActionListener {
	private static HopeCalendar hopeCalendarMember;
	static { 
		hopeCalendarMember = new HopeCalendar(); 
	}
	...
	public static HopeCalendar getInstance() {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HopeCalendar frame = hopeCalendarMember;
		...
		ActionListener dateSetter = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!num.equals("")) {
					...
					System.out.println("CurrentYear: " + (currentYear) + "CurrentMonth: " + (currentMonth + 1)
							+ "CurrentDay: " + day);
					dispose();
				}
			}
	...
	public void display_cal() {
		...
		System.out
				.println("currentYear" + currentYear + "currentDay: " + currentDay + " currentMonth: " + currentMonth);
